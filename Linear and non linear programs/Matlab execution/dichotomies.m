function [ zero,res,niter,inc ] = dichotomies( fun,a,b,tol,nmax,varargin )
...
%     [zero,res,niter,inc]=dicho(fun,...) retourne la valeur approchée du zéro, 
...
elseif fx(1)==0
    zero = a;res=0;niter=0;inc=[];return
elseif fx(3)==0
    zero = b; res=0;niter =0;inc=[];return
end
niter = 0;
I=(b-a)*0.5;
inc=[];
